...
def classify_failure(value: Any) -> str:
    ...
    exact_categories = (
        ...
        ("browser_no_progress", "browser_no_progress"),
        ("browser_evidence_loop", "browser_evidence_loop"),
        ("browser_stale_evidence", "browser_stale_evidence"),
        ("browser_evidence_insufficient", "browser_evidence_insufficient"),
        ("browser_repeated_state_action", "browser_repeated_state_action"),
