...
SCENARIOS = {
    ...
    "bing-fastapi": PublicBrowserScenario(
        ...
        prompt=(
            ...
            "每条字段为 title、source、url；收集三条结果后，必须从最新快照中定位实际包含"
            "fastapi.tiangolo.com 的官方结果标题链接并点击确认官方资料，不能点击广告或泛化的容器 ref。"
            "点击后必须先获取新快照，再从官方页面实际可见内容提取 title、source、url 并 verify。"
