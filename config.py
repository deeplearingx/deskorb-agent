...
API_RETRY_BACKOFF_SECONDS = _env_int("DESKORB_AGENT_API_RETRY_BACKOFF_SECONDS", 2, 1, 10)
API_CIRCUIT_FAILURE_THRESHOLD = _env_int("DESKORB_AGENT_API_CIRCUIT_FAILURE_THRESHOLD", 3, 1, 10)
API_CIRCUIT_COOLDOWN_SECONDS = _env_int("DESKORB_AGENT_API_CIRCUIT_COOLDOWN_SECONDS", 30, 5, 300)
