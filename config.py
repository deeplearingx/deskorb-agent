...
WORKFLOW_TEXT_LIMIT = _env_int("CODEX_OVERLAY_WORKFLOW_TEXT_LIMIT", 100_000, 10_000, 1_000_000)
...
SHOW_IN_SCREEN_SHARE_DEFAULT = True   # True (default) = keep the overlay visible in captures.
                                   # Set the in-app Shareable toggle to private after testing
                                   # only if this system can render the overlay correctly.
                                   # The in-app Shareable toggle applies the choice live.
